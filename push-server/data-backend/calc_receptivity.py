...
def receptivity(json):
	raw_data = pd.read_json(json.raw_data) # should be a dataframe with the rows: phoneId, gsr, heartRates, rrInterval, skinTemperature, location, motionType
...
def clac_features(raw_data):
  ...
  #normalized base values
	...
	return [location, motionType, mSCL, mSCR, mHR, mRR, mSkin, madSCL, madSCR, madHR, madRR, madSkin, stdSCL, stdSCR, stdHR, stdRR, stdSkin, RMSSD]
